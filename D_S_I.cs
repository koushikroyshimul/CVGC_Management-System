...
{
    public partial class D_S_I : Form
    {
        public D_S_I()
        {
            InitializeComponent();
        ...
        {
            Int64 sid = Int64.Parse(S_ID.Text);
            ...
            cmd.CommandText = "delete from Studentinfo where S_id ="+ sid + " ";
        ...
        private void D_S_I_Load(object sender, EventArgs e)
        {
