...
{
    public partial class D_T_I : Form
    {
        public D_T_I()
        {
            InitializeComponent();
        ...
        {
            Int64 Tid = Int64.Parse(T_ID.Text);
            ...
            cmd.CommandText = "delete from Teacherinfo where ID =" + Tid + " ";
        ...
        private void D_T_I_Load(object sender, EventArgs e)
        {
