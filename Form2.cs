...
namespace firstprojecT1
{
    public partial class Form2 : Form
    {
        ...
        private void upgradeClassToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void searchStudentToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            student student = new student();
            student.Show();
            this.Hide();
