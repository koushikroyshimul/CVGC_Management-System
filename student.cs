...
namespace firstprojecT1
{
    public partial class student : Form
    {
        ...
        private void student_id_TextChanged_1(object sender, EventArgs e)
        {
        ...
        private void newAdmissionToolStripMenuItem_Click_2(object sender, EventArgs e)
        {
            Form3 form3 = new Form3();
            form3.Show();
            this.Hide();
